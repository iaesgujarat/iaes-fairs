      ...
      <>
        ...
        <main className="mx-auto max-w-3xl px-6 py-16">
          ...
          <p className="mt-3 text-navy/70">
            ...
            <a className="text-gold-600 hover:underline" href="mailto:eduadviser@iaesgujarat.org">
    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-6 py-12 sm:py-16">
        <div className="mb-8">
          ...
          <p className="mt-3 text-navy/70">
            Two short steps. You&rsquo;ll receive an invoice immediately and can pay online via Razorpay.
          </p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-navy/50">
          ...
          Cancellations must be requested at least 21 days before the fair date for partial refunds.
        </p>
      </main>
      <SiteFooter />
    </>
